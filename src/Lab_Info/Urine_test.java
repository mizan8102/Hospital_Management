 ...
 */
public class Urine_test extends javax.swing.JFrame {

    /**
     * Creates new form Urine_test
     */
    public Urine_test() {
        initComponents();
        cuDate(txtdate);
...
int autoid(){
        ...
        try {
            ...
            Myconnect();
            String m="SELECT `id` FROM `urinetest` ORDER BY `id` ASC";
 ...
 void cuDate(JLabel t){
    ...
    private void initComponents() {
        ...
        jLabel12.setText("RESULT(S)");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(290, 280, 130, 20);
        ...
        jLabel21.setText("MICROBIOLOGY");
        jPanel1.add(jLabel21);
        jLabel21.setBounds(260, 240, 130, 20);

        jLabel22.setText("PH");
        jPanel1.add(jLabel22);
        jLabel22.setBounds(80, 460, 130, 20);

        jLabel23.setText("GLUCOSE");
        jPanel1.add(jLabel23);
        jLabel23.setBounds(80, 490, 130, 20);

        jLabel24.setText("UROBILNOGEN");
        ...
        jLabel26.setText("PUS CELL");
        jPanel1.add(jLabel26);
        jLabel26.setBounds(80, 580, 130, 20);

        jLabel27.setText("EPITHEUEL CELL");
        ...
        jLabel40.setText("APPARANCE");
        jPanel3.add(jLabel40);
        jLabel40.setBounds(60, 120, 110, 20);

        jLabel41.setText("SPECIFIC GRAVITY");
        ...
        setSize(new java.awt.Dimension(1148, 770));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            ...
            String m="INSERT INTO `urinetest`( `pid`,`pname`,`date`,`physical`,`color`,`apparence`,`gravity`,`protein`,`ph`,`glucose`,`uro`,`blood`,`puscell`,`epi`) VALUES" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Urine_test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
