...
Sales_report sr=new Sales_report();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Id", "Product Name", "Group Name", "Purchase Quantity", "Sales Quantity", "Stock"
            }
        ));
    ...
    private void searchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyPressed
        ...
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            String m="SELECT *FROM `stock_report` WHERE `pname`='"+id+"' OR `name`='"+id+"'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String m="SELECT *FROM `stock_report`";
        show(m);
        ...
        try {
            ...
            while(pi.rs.next()){
                ...
                if((pi.rs.getInt(5))>0){
                    ...
                    a=pi.rs.getInt(4)-pi.rs.getInt(5);
                    sq=pi.rs.getInt(5);
                }
                else{
                    a=pi.rs.getInt(4);
                }
                dt.addRow(new Object[]{pi.rs.getString(1),pi.rs.getString(2),pi.rs.getString(3),pi.rs.getString(4),sq,a});
            }
